//
// saltalila: an HTML5 "Doodle Jump"-style game
//
// Forked from: https://github.com/ntcnet83/html5-doodle-jump
// Authors:
// https://twitter.com/solitarydesigns
// https://twitter.com/_rishabhp
//
// Adaptation by:
// https://twitter.com/scoffey
//
...
function init() {
  ...
  function playerCalc() {
    ...
    //When the player reaches half height, move the platforms to create the illusion of scrolling and recreate the platforms that are out of viewport...
      ...
      backgroundOffset -= player.vy / 2;
      canvas.style['background-position'] = '0 ' + backgroundOffset + 'px';
      base.y -= player.vy;
      player.vy += gravity;
...
function showGoMenu() {
  ...
  scoreText.innerHTML = "Votos de la oposición: " + score;
}
